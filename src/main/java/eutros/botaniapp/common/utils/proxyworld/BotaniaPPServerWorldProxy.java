...
public class BotaniaPPServerWorldProxy extends ServerWorld {
    private ServerWorld innerWorld;

    public BotaniaPPServerWorldProxy(ServerWorld world) {
        super(world.getServer(),
                world.getServer().getBackgroundExecutor(),
                world.getSaveHandler(),
                world.getWorldInfo(),
                world.getDimension().getType(),
                world.getProfiler(),
                new IChunkStatusListener() {
                    @Override
    ...
    @Override
    public void tickEnvironment(Chunk p_217441_1_, int p_217441_2_) {
        innerWorld.tickEnvironment(p_217441_1_, p_217441_2_);
    }

    @Override
    public boolean isInsideTick() {
        return innerWorld.isInsideTick();
    }

    @Override
    public void updateAllPlayersSleepingFlag() {
        innerWorld.updateAllPlayersSleepingFlag();
    }

    @Override
    public void resetUpdateEntityTick() {
        innerWorld.resetUpdateEntityTick();
    }

    @Override
    public void updateEntity(Entity p_217479_1_) {
        innerWorld.updateEntity(p_217479_1_);
    }

    @Override
    public void func_217459_a(Entity p_217459_1_, Entity p_217459_2_) {
        innerWorld.func_217459_a(p_217459_1_, p_217459_2_);
    }

    @Override
    public void chunkCheck(Entity p_217464_1_) {
        innerWorld.chunkCheck(p_217464_1_);
    }

    @Override
    public void createSpawnPosition(WorldSettings p_73052_1_) {
        innerWorld.createSpawnPosition(p_73052_1_);
    }

    @Nullable
    @Override
    public BlockPos getSpawnCoordinate() {
        return innerWorld.getSpawnCoordinate();
    }
    ...
    public <T extends IParticleData> int spawnParticle(T p_195598_1_, double p_195598_2_, double p_195598_4_, double p_195598_6_, int p_195598_8_, double p_195598_9_, double p_195598_11_, double p_195598_13_, double p_195598_15_) {
        return innerWorld.spawnParticle(p_195598_1_, p_195598_2_, p_195598_4_, p_195598_6_, p_195598_8_, p_195598_9_, p_195598_11_, p_195598_13_, p_195598_15_);
    }
    ...
    public <T extends IParticleData> boolean spawnParticle(ServerPlayerEntity p_195600_1_, T p_195600_2_, boolean p_195600_3_, double p_195600_4_, double p_195600_6_, double p_195600_8_, int p_195600_10_, double p_195600_11_, double p_195600_13_, double p_195600_15_, double p_195600_17_) {
        return innerWorld.spawnParticle(p_195600_1_, p_195600_2_, p_195600_3_, p_195600_4_, p_195600_6_, p_195600_8_, p_195600_10_, p_195600_11_, p_195600_13_, p_195600_15_, p_195600_17_);
    }

    @Nullable
    @Override
    public Entity getEntityByUuid(UUID p_217461_1_) {
        return innerWorld.getEntityByUuid(p_217461_1_);
    }

    @Nullable
    @Override
    public BlockPos findNearestStructure(String p_211157_1_, BlockPos p_211157_2_, int p_211157_3_, boolean p_211157_4_) {
        return innerWorld.findNearestStructure(p_211157_1_, p_211157_2_, p_211157_3_, p_211157_4_);
    }

    @Override
    public void checkSessionLock() throws SessionLockException {
        innerWorld.checkSessionLock();
    }

    @Override
    public SaveHandler getSaveHandler() {
        return innerWorld.getSaveHandler();
    }

    @Override
    public LongSet getForcedChunks() {
        return innerWorld.getForcedChunks();
    }

    @Override
    public boolean forceChunk(int p_217458_1_, int p_217458_2_, boolean p_217458_3_) {
        return innerWorld.forceChunk(p_217458_1_, p_217458_2_, p_217458_3_);
    }

    @Override
    public PointOfInterestManager getPointOfInterestManager() {
        return innerWorld.getPointOfInterestManager();
    }

    @Override
    public boolean func_217483_b_(BlockPos p_217483_1_) {
        return innerWorld.func_217483_b_(p_217483_1_);
    }

    @Override
    public boolean func_222887_a(SectionPos p_222887_1_) {
        return innerWorld.func_222887_a(p_222887_1_);
    }

    @Override
    public boolean func_217471_a(BlockPos p_217471_1_, int p_217471_2_) {
        return innerWorld.func_217471_a(p_217471_1_, p_217471_2_);
    }

    @Override
    public int func_217486_a(SectionPos p_217486_1_) {
        return innerWorld.func_217486_a(p_217486_1_);
    }

    @Override
    public RaidManager getRaids() {
        return innerWorld.getRaids();
    }

    @Nullable
    @Override
    public Raid findRaid(BlockPos p_217475_1_) {
        return innerWorld.findRaid(p_217475_1_);
    }

    @Override
    public boolean hasRaid(BlockPos p_217455_1_) {
        return innerWorld.hasRaid(p_217455_1_);
    }

    @Override
    public void updateReputation(IReputationType p_217489_1_, Entity p_217489_2_, IReputationTracking p_217489_3_) {
        innerWorld.updateReputation(p_217489_1_, p_217489_2_, p_217489_3_);
    }

    @Override
    public void func_225322_a(Path p_225322_1_) throws IOException {
        innerWorld.func_225322_a(p_225322_1_);
    }

    @Override
    public void func_229854_a_(MutableBoundingBox p_229854_1_) {
        innerWorld.func_229854_a_(p_229854_1_);
    }

    @Override
    public Stream<Entity> getEntities() {
        return innerWorld.getEntities();
    }
    ...
    public void setSpawnPoint(BlockPos p_175652_1_) {
        innerWorld.setSpawnPoint(p_175652_1_);
    }
    ...
    public List<Entity> getEntities(@Nullable EntityType<?> p_217482_1_, Predicate<? super Entity> p_217482_2_) {
        return innerWorld.getEntities(p_217482_1_, p_217482_2_);
    }

    @Override
    public List<ServerPlayerEntity> getPlayers(Predicate<? super ServerPlayerEntity> p_217490_1_) {
        return innerWorld.getPlayers(p_217490_1_);
    }
