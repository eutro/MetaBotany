...
public class BotaniaPPWorldProxy extends World {

    private World innerWorld;

    public BotaniaPPWorldProxy(World world) {
        super(world.getWorldInfo(), world.getDimension().getType(), (a, b) -> world.getChunkProvider(), world.getProfiler(), world.isRemote());
        innerWorld = world;
    }
