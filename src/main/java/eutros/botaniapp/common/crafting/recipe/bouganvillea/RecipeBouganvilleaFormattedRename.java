...
public class RecipeBouganvilleaFormattedRename extends RecipeBouganvilleaRename {
    ...
    public boolean shouldTrigger(IBouganvilleaInventory inv) {
        ...
        return stack.getCount() != 1 ||
                (stack.getItem() != BotaniaPPItems.BOTANIA_RED_STRING &&
                 stack.getItem() != BotaniaPPItems.BOTANIA_MANA_STRING);
    }
    ...
    public boolean matches(IBouganvilleaInventory inventory, World world) {
        return inventory.getSizeInventory() > 1 ||
                inventory.getThrown().getItem().getItem() == BotaniaPPItems.BOTANIA_RED_STRING;
    }
    ...
    private final ItemStack redString = new ItemStack(BotaniaPPItems.BOTANIA_RED_STRING);
