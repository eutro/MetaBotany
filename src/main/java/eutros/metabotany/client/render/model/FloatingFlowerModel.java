package eutros.metabotany.client.render.model;
...
public class FloatingFlowerModel implements IModelGeometry<FloatingFlowerModel> {
    ...
    public static class Baked extends BakedModelWrapper<IBakedModel> {
        ...
        @Nonnull
        @Override
        public IBakedModel handlePerspective(@Nonnull ItemCameraTransforms.TransformType cameraTransformType, @NotNull MatrixStack ms) {
