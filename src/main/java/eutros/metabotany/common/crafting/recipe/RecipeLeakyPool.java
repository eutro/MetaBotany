...
import eutros.metabotany.client.integration.jei.MetaBotanyPlugin;
import eutros.metabotany.client.integration.jei.RecipeCategoryTNTPool;
...
public class RecipeLeakyPool {
    ...
    public static void onChange(String name, boolean value) {
        ...
        IRecipeManager manager = MetaBotanyPlugin.runtime.getRecipeManager();
        if(value) {
    ...
    public static void onExplosion(ExplosionEvent.Detonate event) {
        ...
        if(state.getBlock() == MetaBotanyBlocks.BOTANIA_MANA_POOL) {
            ...
            world.setBlockState(pos, MetaBotanyBlocks.leakyPool.getDefaultState());
