...
import eutros.metabotany.api.internal.block.state.StateRedstoneControlled;
import eutros.metabotany.api.internal.config.Configurable;
import eutros.metabotany.client.core.helper.HUDHelper;
...
public class TileLeakyPool extends TileSimpleInventory implements IManaPool, IKeyLocked, ISparkAttachable, IThrottledPacket, ITickableTileEntity, IManaSpreader {
    ...
    public boolean isFull() {
        ...
        return blockBelow != MetaBotanyBlocks.BOTANIA_MANA_VOID && getCurrentMana() >= MAX_MANA;
    }
    ...
    private void tryShootBurst() {
        ...
        if(world != null && !world.isRemote) {
            ...
            burst.ping();
            // TODO use own sound
            world.playSound(null, pos, MetaBotanySounds.BOTANIA_SPREADER_FIRE, SoundCategory.BLOCKS, 0.05F, 0.7F + 0.3F * (float) Math.random());
            markDispatchable();
    ...
    public void onWanded(PlayerEntity player) {
        ...
        world.playSound(null, playerPos.x, playerPos.y, playerPos.z, MetaBotanySounds.BOTANIA_DING, SoundCategory.PLAYERS, 0.11F, 1F);
    }
    ...
    public int getAvailableSpaceForMana() {
        ...
        if(space > 0)
            ...
            assert world != null;
            if(world.getBlockState(pos.down()).getBlock() == MetaBotanyBlocks.BOTANIA_MANA_VOID)
                return MAX_MANA;
            else return 0;
        }
    }
