package eutros.metabotany.common.block.tile.corporea;

import com.mojang.blaze3d.platform.GlStateManager;
import eutros.metabotany.common.block.tile.corporea.matchers.AdvancedMatcher;
...
public class TileAdvancedFunnel extends TileCorporeaBase implements ICorporeaRequestor, ITileBound {
    ...
    private int range = 3;
    private String match = I18n.format("hud.metabotany.advanced_funnel.no_match");
        ...
        if(spark != null && spark.getMaster() != null) {
            ...
            if(!filter.isEmpty()) {
                ...
                if(!stack.isEmpty()) {
                    ...
                    match = I18n.format("hud.metabotany.advanced_funnel.prev_match") + " " +
