...
import eutros.metabotany.api.internal.block.BlockRedstoneControlledWaterloggable;
import eutros.metabotany.common.block.tile.TileLeakyPool;
import eutros.metabotany.common.block.tile.TileSimpleInventory;
import eutros.metabotany.common.core.helper.InventoryHelper;
...
public class BlockLeakyPool extends BlockRedstoneControlledWaterloggable implements IWandHUD, IWandable {
    ...
    public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult hit) {
        ...
        if(!lstack.isEmpty() && !(pstack.getItem() == MetaBotanyItems.BOTANIA_SPARK)) {
