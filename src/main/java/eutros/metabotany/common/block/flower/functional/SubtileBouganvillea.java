package eutros.metabotany.common.block.flower.functional;
...
public class SubtileBouganvillea extends TileEntityFunctionalFlower {
    ...
    public static final String BUILTIN_GROUP = "metabotany:bouganvillea_builtin";
    private static final String TAG_MEMORY = "item_memory";
    private static final String TAG_RECIPE = "active_recipe";
    private static final String TAG_ANVILLED = "metabotany_bouganvilled";
        ...
        for(ItemEntity e : items) {
            ...
            if(activeRecipes.isEmpty()) {
                if(unresolvedRecipes.isEmpty()) {
                    activeRecipes = world.getRecipeManager().getRecipes(MetaBotanyRecipeTypes.BOUGANVILLEA_TYPE.type, inventory, world);
                } else {
