...
public abstract class BlockRedstoneControlledWaterloggable extends BlockRedstoneControlled implements IWaterLoggable {

    public BlockRedstoneControlledWaterloggable(Properties properties) {
        super(properties);
