package eutros.metabotany.asm;

import eutros.metabotany.common.enchantment.MetaBotanyEnchantments;
import eutros.metabotany.common.enchantment.EnchantmentSharper;
...
public class ASMHooks {
    ...
    public static int manaLensEnchantSharper(int base, ItemStack stack) {
        int level = EnchantmentHelper.getEnchantmentLevel(MetaBotanyEnchantments.lensSharper, stack);
    ...
    public static boolean instanceOfHook(Object test, ItemStack stack, int desc) {
        if(stack == null ||
                !(stack.getItem() == MetaBotanyItems.unresponsiveLens ||
                        (stack.getItem() instanceof ICompositableLens &&
                                ((ICompositableLens) stack.getItem()).getCompositeLens(stack).getItem() == MetaBotanyItems.unresponsiveLens))) {
            switch(desc) {
                case 0:
